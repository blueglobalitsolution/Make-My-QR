...
export const Account: React.FC<AccountProps> = ({
  ...
  return (
    <div className="h-full overflow-y-auto scrollbar-hide p-12 max-w-5xl mx-auto w-full space-y-10 animate-in fade-in duration-700 pb-24">
      ...
      <div className="flex gap-10 skeu-inset p-1 rounded-2xl w-fit">
        <button className="px-6 py-3 text-sm font-black skeu-tag-active">Profile Details</button>
        <button className="px-6 py-3 text-sm font-black skeu-text-muted hover:skeu-text-primary transition-all">Billing & Plans</button>
      </div>
