...
export const Wizard: React.FC<WizardProps> = ({
  ...
  const handlePreviewPasswordSubmit = (password: string) => {
    if (password === wizard.password) {
      setPreviewIsPasswordVerified(true);
      return true;
    }
    return false;
  };
  ...
  React.useEffect(() => {
    setPreviewIsPasswordVerified(false);
  }, [wizard.is_protected]);
  ...
  const renderStep3Style = () => (
    <div className="space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-500">
      ...
      <div className="space-y-6">
        ...
        {/* Name Section */}
        <div className="skeu-accordion overflow-hidden animate-in fade-in slide-in-from-bottom-4 duration-500 delay-200 mb-6">
          <button
